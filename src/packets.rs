...
//     Packets,
//     for<'lt> fn(player: &'lt mut Player, reader: &'lt mut Reader) -> BoxFuture<'lt, bool>,
// >;
...
//         $pub:vis
//         async
//         fn $fname:ident ($player:ident : & $('_)? mut Player, $reader:ident : & $('_)? mut Reader) -> bool
//         $body:block
//     )*
// ) => (
//     $(
...
//     pub async fn ping(player: &mut Player, reader: &mut Reader) -> bool {
//         true
//     }
