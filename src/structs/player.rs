...
//     pub fn remaining_silence(&self) -> i32 {
//         let now = Utc::now();
...
//         let mut ret = ClientPrivileges::empty();

//         if self._priv() & Privileges::NORMAL {
//             ret |= ClientPrivileges::PLAYER;
//         }
//         if self._priv() & Privileges::DONATOR {
//             ret |= ClientPrivileges::SUPPORTER;
//         }
//         if self._priv() & Privileges::MODERATOR {
//             ret |= ClientPrivileges::MODERATOR;
//         }
//         if self._priv() & Privileges::ADMINISTRATOR {
//             ret |= ClientPrivileges::DEVELOPER;
//         }
//         if self._priv() & Privileges::DEVELOPER {
...
//         self.memory.token = Some(uuid::Uuid::new_v4().to_string());
//     }
...
//         log(format!("{} logged out.", self), Ansi::LYELLOW);
//     }
// }
